...
<section
  ...
  style={{
    backgroundImage: "linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)),url('/img/Objetivo/PANTALLA1.jpg')",
...
>      <h2 className="text-5xl text-center  font-sans mt-16">
 ...
 <div class='content relative w-60 h-60 border-8 border-blue-500 rounded-full flex items-center justify-center'>
  <a href="indexCN.html">
