...
const ProfileCard = ({ imgSrc, name, role, portfolioLink, githubLink, linkedinLink }) => {
  ...
  return (
    <div id="Quienes_Somos" className='ml-6 p-3'>
      <div className="relative flex flex-col text-gray-700 bg-white shadow-md w-64 h-96 rounded-xl bg-clip-border overflow-hidden transform transition-transform ease-in-out hover:scale-105 group">
        ...
        <div className="flex justify-center space-x-5 opacity-0 group-hover:opacity-100 transition-opacity ease-in-out duration-300 absolute bottom-2 left-0 right-0 mx-auto">
          <button onClick={() => openLink(portfolioLink)} className="inline-block text-gray-400">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-briefcase-fill w-6 h-6 text-gray-500 hover:text-black " viewBox="0 0 16 16">
          ...
          <button onClick={() => openLink(githubLink)} className="inline-block text-gray-400">
            ...
            <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 496 512" className="w-6 h-6 text-gray-500 hover:text-black" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
          ...
          <button onClick={() => openLink(linkedinLink)} className="inline-block text-gray-400">
            ...
            <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" className="w-6 h-6 text-gray-500 hover:text-black" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
