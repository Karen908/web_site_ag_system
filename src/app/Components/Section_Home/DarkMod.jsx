            ...
            >
              <div
                ...
                className={`w-6 h-6 relative rounded-full transition duration-500 transform p-1 text-white ${
                  theme === "dark" ? 'bg-blue-700 translate-x-full ' : 'bg-yellow-400 -translate-x-1'
                }`}
              >
                {theme === "dark" ? (
                  <svg xmlns="http://www.w3.org/2000/svg"  fill="currentColor" className="bi bi-moon-stars w-4 h-4 " viewBox="0 0 16 16">
